...
void loop() {
  ...
  packetnum=0;
  char radiopacket[4] = "";
  itoa(packetnum++, radiopacket, 4);
  Serial.print("Sending "); Serial.println(radiopacket);

  if (radio.sendWithRetry(RECEIVER, radiopacket, strlen(radiopacket), 10, 10)) { //target node Id, message as string or byte array, message length
    Serial.println("OK");
